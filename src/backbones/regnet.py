...
from mmdet.models.backbones.resnet import Bottleneck as ResNetBottleneck

from ..attention_modules import ChannelAttention
...
class RegNet(ResNet):
    ...
    def __init__(self,
        ...
        self.se_on = se_on
        self.block = SEBlock if self.se_on else Bottleneck
...
class Bottleneck(ResNetBottleneck):
    ...
    def __init__(self,
        ...
        if groups == 1:
            ...
            self.width = math.floor(self.planes *
...
class SEBlock(Bottleneck):
    def __init__(self, **kwargs):
        ...
        self.channel_attention = ChannelAttention(channels=self.width)
